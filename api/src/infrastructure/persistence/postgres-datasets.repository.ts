...
export class PostgresDatasetsRepository implements DatasetsRepositoryPort {
  ...
  async getRowsBySourceTable(sourceTable: string): Promise<Record<string, unknown>[]> {
    ...
    const allowedTables = ['samples', 'isolates', 'staramr_isolates', 'example_amrfinder_plus'];
